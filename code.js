...
`;
     ...
     * @returns
     */
    function getVariableValue(mode, key, originalVariableName) {
...
function findReferenceHex(parsedChildMode, modeObj, originalVariableName) {
 ...
 * @returns
 */
function getVariableMode(variableId) {
 ...
 * @returns
 */
function getRgbFromMode(modeObj, pureObj) {
